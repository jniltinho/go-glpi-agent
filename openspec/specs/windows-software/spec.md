...
Collect Windows installed software from the uninstall registry keys (avoiding `Win32_Product`),
plus local users/groups and the logged-in session, for the inventory's software and user
sections.
