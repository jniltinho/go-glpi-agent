# freebsd-hardware Specification

## Purpose

Collect FreeBSD hardware inventory: CPU and memory, BIOS/board/chassis/UUID via
kenv SMBIOS, and physical disks, filesystems and USB devices.
