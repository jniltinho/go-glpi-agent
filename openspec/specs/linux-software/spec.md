# linux-software Specification

## Purpose

Inventário de software em Linux: pacotes dpkg (Debian/Ubuntu), RPM
(RedHat/CentOS/Fedora), Pacman (Arch) e detecção automática do gerenciador.
